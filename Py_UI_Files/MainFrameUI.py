...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1269, 757))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 999, 682))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 999, 682))
        ...
        self.tabJunction = QtWidgets.QWidget()
        self.tabJunction.setObjectName("tabJunction")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.tabJunction)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(9, 9, 1237, 705))
        ...
        self.listJunction = QtWidgets.QListWidget(self.widget_3)
        self.listJunction.setGeometry(QtCore.QRect(9, 9, 200, 684))
        self.listJunction.setMaximumSize(QtCore.QSize(200, 684))
        self.listJunction.setObjectName("listJunction")
        self.scrollArea_4 = QtWidgets.QScrollArea(self.widget_3)
        self.scrollArea_4.setGeometry(QtCore.QRect(215, 9, 1010, 684))
        self.scrollArea_4.setMaximumSize(QtCore.QSize(16777215, 684))
        self.scrollArea_4.setWidgetResizable(True)
        self.scrollArea_4.setObjectName("scrollArea_4")
        self.scrollAreaWidgetContents_4 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 1008, 682))
        self.scrollAreaWidgetContents_4.setObjectName("scrollAreaWidgetContents_4")
        self.formLayoutWidget = QtWidgets.QWidget(self.scrollAreaWidgetContents_4)
        self.formLayoutWidget.setGeometry(QtCore.QRect(9, 9, 988, 663))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.formLayout_Jun = QtWidgets.QFormLayout(self.formLayoutWidget)
        self.formLayout_Jun.setSizeConstraint(QtWidgets.QLayout.SetNoConstraint)
        self.formLayout_Jun.setContentsMargins(50, 10, 50, 10)
        self.formLayout_Jun.setHorizontalSpacing(10)
        self.formLayout_Jun.setVerticalSpacing(12)
        self.formLayout_Jun.setObjectName("formLayout_Jun")
        self.scrollArea_4.setWidget(self.scrollAreaWidgetContents_4)
        self.horizontalLayout.addWidget(self.widget_3)
        self.tabInner.addTab(self.tabJunction, "")
        self.tabConduit = QtWidgets.QWidget()
        self.tabConduit.setObjectName("tabConduit")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.tabConduit)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(9, 11, 1237, 705))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_3)
        self.horizontalLayout_11.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.widget_7 = QtWidgets.QWidget(self.horizontalLayoutWidget_3)
        self.widget_7.setEnabled(True)
        self.widget_7.setObjectName("widget_7")
        self.listConduit = QtWidgets.QListWidget(self.widget_7)
        self.listConduit.setGeometry(QtCore.QRect(9, 9, 200, 684))
        self.listConduit.setMaximumSize(QtCore.QSize(200, 684))
        self.listConduit.setObjectName("listConduit")
        self.scrollArea_8 = QtWidgets.QScrollArea(self.widget_7)
        self.scrollArea_8.setGeometry(QtCore.QRect(215, 9, 1010, 684))
        self.scrollArea_8.setMaximumSize(QtCore.QSize(16777215, 684))
        self.scrollArea_8.setWidgetResizable(True)
        self.scrollArea_8.setObjectName("scrollArea_8")
        self.scrollAreaWidgetContents_8 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 1008, 682))
        self.scrollAreaWidgetContents_8.setObjectName("scrollAreaWidgetContents_8")
        self.formLayoutWidget_3 = QtWidgets.QWidget(self.scrollAreaWidgetContents_8)
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(9, 9, 988, 663))
        self.formLayoutWidget_3.setObjectName("formLayoutWidget_3")
        self.formLayout_Con = QtWidgets.QFormLayout(self.formLayoutWidget_3)
        self.formLayout_Con.setSizeConstraint(QtWidgets.QLayout.SetNoConstraint)
        self.formLayout_Con.setContentsMargins(50, 10, 50, 10)
        self.formLayout_Con.setHorizontalSpacing(10)
        self.formLayout_Con.setVerticalSpacing(12)
        self.formLayout_Con.setObjectName("formLayout_Con")
        self.scrollArea_8.setWidget(self.scrollAreaWidgetContents_8)
        self.horizontalLayout_11.addWidget(self.widget_7)
        self.tabInner.addTab(self.tabConduit, "")
        self.tabOutfall = QtWidgets.QWidget()
        self.tabOutfall.setObjectName("tabOutfall")
        self.horizontalLayoutWidget_4 = QtWidgets.QWidget(self.tabOutfall)
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(10, 9, 1237, 705))
        self.horizontalLayoutWidget_4.setObjectName("horizontalLayoutWidget_4")
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_4)
        self.horizontalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.widget_8 = QtWidgets.QWidget(self.horizontalLayoutWidget_4)
        self.widget_8.setEnabled(True)
        self.widget_8.setObjectName("widget_8")
        self.listOutfall = QtWidgets.QListWidget(self.widget_8)
        self.listOutfall.setGeometry(QtCore.QRect(9, 9, 200, 684))
        self.listOutfall.setMaximumSize(QtCore.QSize(200, 684))
        self.listOutfall.setObjectName("listOutfall")
        self.scrollArea_9 = QtWidgets.QScrollArea(self.widget_8)
        self.scrollArea_9.setGeometry(QtCore.QRect(215, 9, 1010, 684))
        self.scrollArea_9.setMaximumSize(QtCore.QSize(16777215, 684))
        self.scrollArea_9.setWidgetResizable(True)
        self.scrollArea_9.setObjectName("scrollArea_9")
        self.scrollAreaWidgetContents_9 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_9.setGeometry(QtCore.QRect(0, 0, 1008, 682))
        self.scrollAreaWidgetContents_9.setObjectName("scrollAreaWidgetContents_9")
        self.formLayoutWidget_4 = QtWidgets.QWidget(self.scrollAreaWidgetContents_9)
        self.formLayoutWidget_4.setGeometry(QtCore.QRect(9, 9, 988, 663))
        self.formLayoutWidget_4.setObjectName("formLayoutWidget_4")
        self.formLayout_Out = QtWidgets.QFormLayout(self.formLayoutWidget_4)
        self.formLayout_Out.setSizeConstraint(QtWidgets.QLayout.SetNoConstraint)
        self.formLayout_Out.setContentsMargins(50, 10, 50, 10)
        self.formLayout_Out.setHorizontalSpacing(10)
        self.formLayout_Out.setVerticalSpacing(12)
        self.formLayout_Out.setObjectName("formLayout_Out")
        self.scrollArea_9.setWidget(self.scrollAreaWidgetContents_9)
        self.horizontalLayout_12.addWidget(self.widget_8)
        self.tabInner.addTab(self.tabOutfall, "")
        ...
        self.tabInner.setCurrentIndex(4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabInner.setTabText(self.tabInner.indexOf(self.tabJunction), _translate("MainWindow", "Junction"))
        self.tabConduit.setAccessibleName(_translate("MainWindow", "tabConduit"))
        self.tabInner.setTabText(self.tabInner.indexOf(self.tabConduit), _translate("MainWindow", "Conduit"))
        self.tabInner.setTabText(self.tabInner.indexOf(self.tabOutfall), _translate("MainWindow", "Outfall"))
